...
@EnableKafka
@Configuration
@ConditionalOnProperty(prefix = "starter.boot.kafka-connector.consumer",
    name = "enabled",
    havingValue = "true",
    matchIfMissing = true)
public class KafkaConsumerConfig {
  ...
  @Bean
  // CSOFF: LineLength
  public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<Integer, Object>> kafkaListenerContainerFactory(ConsumerFactory<Integer, Object> consumerFactory) {
    // CSON: LineLength
