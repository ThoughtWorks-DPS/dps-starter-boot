...
public class KafkaProducerConfigPropertiesTest {
  ...
  @Autowired private SpringKafkaProducerConfigProperties springKafkaProducerConfigProperties;

  @Autowired private AlternateKafkaProducerConfigProperties testConfigProperties;
