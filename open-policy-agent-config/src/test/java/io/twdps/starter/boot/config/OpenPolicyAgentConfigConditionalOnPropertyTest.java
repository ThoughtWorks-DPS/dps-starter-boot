...
class OpenPolicyAgentConfigConditionalOnPropertyTest {
  ...
  private ApplicationContextRunner context = new ApplicationContextRunner()
      .withUserConfiguration(OpenPolicyAgentConfig.class)
  ...
  void istioSecurityConfigIsDisabledProperly() {
    context
        ...
        .run(context -> assertAll(
            () -> assertThat(context).doesNotHaveBean(OpenPolicyAgentConfig.class)));
  }
  ...
  void istioSecurityConfigIsEnabledProperly() {
    context
        ...
        .run(context -> assertAll(
            () -> assertThat(context).hasSingleBean(OpenPolicyAgentConfig.class)));
  }
