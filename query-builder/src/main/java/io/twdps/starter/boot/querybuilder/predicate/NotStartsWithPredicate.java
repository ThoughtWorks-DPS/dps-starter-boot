...
public class NotStartsWithPredicate<T> extends BasePredicate<T> {

  public NotStartsWithPredicate(ObjectMapper objectMapper, Class<? extends Serializable> idClazz) {
