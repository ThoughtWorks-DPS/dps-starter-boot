...
class LikePredicateTest {
  ...
  private final LikePredicate<Object> likePredicate =
      new LikePredicate<>(new ObjectMapper(), Long.class);
  ...
  void testToPredicateWhenNestedSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "nested", SearchOperation.LIKE, "name=text");
    likePredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.LIKE, "text");
    likePredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenNestedOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.LIKE, "name=text");
    likePredicate.setSearchCriteria(searchCriteria);
