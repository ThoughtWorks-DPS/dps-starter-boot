...
class NotContainsPredicateTest {
  ...
  private final NotContainsPredicate<Object> notContainsPredicate =
      new NotContainsPredicate<>(new ObjectMapper(), Long.class);

  @Test
  void testToPredicateWhenSingleSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "name", SearchOperation.CONTAINS, "text");
    notContainsPredicate.setSearchCriteria(searchCriteria);
    ...
    notContainsPredicate.toPredicate(root, criteriaQuery, criteriaBuilder);
  ...
  void testToPredicateWhenNestedSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "nested", SearchOperation.CONTAINS, "name=text");
    notContainsPredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.CONTAINS, "text");
    notContainsPredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenNestedOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.CONTAINS, "name=text");
    notContainsPredicate.setSearchCriteria(searchCriteria);
