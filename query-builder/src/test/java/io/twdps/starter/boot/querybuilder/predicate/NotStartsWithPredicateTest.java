...
class NotStartsWithPredicateTest {
  ...
  private final NotStartsWithPredicate<Object> notStartsWithPredicate =
      new NotStartsWithPredicate<>(new ObjectMapper(), Long.class);

  @Test
  void testToPredicateWhenSingleSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "name", SearchOperation.STARTS_WITH, "text");
    notStartsWithPredicate.setSearchCriteria(searchCriteria);
    ...
    notStartsWithPredicate.toPredicate(root, criteriaQuery, criteriaBuilder);
  ...
  void testToPredicateWhenNestedSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "nested", SearchOperation.STARTS_WITH, "name=text");
    notStartsWithPredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenNestedOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.STARTS_WITH, "name=text");
    notStartsWithPredicate.setSearchCriteria(searchCriteria);
