...
class UnlikePredicateTest {
  ...
  private final UnlikePredicate<Object> unlikePredicate =
      new UnlikePredicate<>(new ObjectMapper(), Long.class);

  @Test
  void testToPredicateWhenSingleSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "name", SearchOperation.UNLIKE, "text");
    unlikePredicate.setSearchCriteria(searchCriteria);
    ...
    unlikePredicate.toPredicate(root, criteriaQuery, criteriaBuilder);
  ...
  void testToPredicateWhenNestedSearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "nested", SearchOperation.UNLIKE, "name=text");
    unlikePredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.UNLIKE, "text");
    unlikePredicate.setSearchCriteria(searchCriteria);
  ...
  void testToPredicateWhenNestedOneToManySearchCriteriaValue() {
    SearchCriteria searchCriteria =
        new SearchCriteria(false, "list.nested", SearchOperation.UNLIKE, "name=text");
    unlikePredicate.setSearchCriteria(searchCriteria);
