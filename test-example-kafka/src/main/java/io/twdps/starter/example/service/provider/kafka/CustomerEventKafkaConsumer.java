...
public class CustomerEventKafkaConsumer {
  ...
  public void handleMessage(
      CustomerEventMessage payload, String topic, Integer partition, Long offset) {
    log.debug(
  ...
  public void handleMessage(CustomerEventMessage event) {
    ...
    log.debug(
        "Received Message with event type:{}, customerID:{}",
        event.getType(),
        event.getCustomerId());
  }
